...
$lang_module['categories'] = 'Loại dự án';
$lang_module['save'] = 'Lưu thay đổi';
$lang_module['action'] = 'Thực hiện';
$lang_module['reset'] = 'Xóa trắng';
$lang_module['move'] = 'Di chuyển dự án';
$lang_module['save_temp'] = 'Lưu dự án không đăng';
$lang_module['publtime'] = 'Đăng dự án';
$lang_module['exptime'] = 'Cho hết hạn dự án';
...
$lang_module['saveok'] = 'Cập nhật dự án thành công';
$lang_module['alias'] = 'Liên kết tĩnh';
$lang_module['name'] = 'Tên dự án';
$lang_module['error_name'] = 'Lỗi:Bạn cần nhập Tên dự án';
$lang_module['weight'] = 'Vị trí';
$lang_module['numsubcat'] = 'Số loại dự án con';
$lang_module['inhome'] = 'Hiển thị trang chủ';
$lang_module['indetail'] = 'Hiển thị cùng dự án';
$lang_module['indetail_note'] = 'Hiển thị thông tin nhóm dự án đi kèm tên dự án';
...
$lang_module['typeprice_per_product'] = 'Từng dự án';
$lang_module['typeprice_none'] = 'Không giảm giá';
$lang_module['content_list'] = 'Danh sách dự án';
$lang_module['content_add'] = 'Thêm dự án';
$lang_module['add_cat'] = 'Thêm loại dự án';
$lang_module['edit_cat'] = 'Sửa loại dự án';
$lang_module['siteinfo_publtime'] = 'Tổng số dự án';
$lang_module['siteinfo_pending'] = 'Số dự án chờ đăng';
...
$lang_module['siteinfo_expired'] = 'Số dự án đã hết hạn';
$lang_module['siteinfo_tags_incomplete'] = 'Số tags chưa có mô tả';
$lang_module['catalog_name'] = 'Tên loại dự án';
...
$lang_module['content_add_items'] = 'Danh sách dự án';
...
$lang_module['document_payment_note'] = 'Nội dung này hiển trong phần chi tiết mỗi dự án hỗ trợ thanh toán';
...
$lang_module['document_payment_note'] = 'Nội dung này hiển trong phần chi tiết mỗi dự án hỗ trợ thanh toán';
$lang_module['cat_title'] = 'Danh sách loại dự án';
...
$lang_module['delcat_msg_rows'] = 'Chủ đề có %s dự án, bạn có chắc chắn xóa hoặc di chuyển sang chủ đề khác';
$lang_module['delcat_msg_rows_select'] = 'Chú ý: chủ đề %1$s có %2$s dự án. <br>Bạn xóa chủ đề này tức là xóa tất cả dự án bên trong nó.';
$lang_module['delcat_msg_rows_move'] = 'Hoặc chọn chủ đề để di chuyển dự án tới';
$lang_module['delcatandrows'] = 'Xóa chủ đề và các dự án';
$lang_module['delcat_msg_rows_noselect'] = 'Bạn cần chọn chủ đề để di chuyển dự án tới';
...
$lang_module['setting_hometext'] = 'Hiển thị phần giới thiệu gắn gọn khi xem chi tiết dự án';
$lang_module['setting_per_page'] = 'Số dự án được hiển thị trong một trang';
$lang_module['setting_per_row'] = 'Số dự án được hiển thị trên một hàng (hiển thị dạng lưới)';
...
$lang_module['setting_up_products'] = 'Tự động đăng dự án không cần qua kiểm duyệt (thành viên)';
$lang_module['setting_up_products_shop'] = 'Tự động đăng dự án không cần qua kiểm duyệt (gian hàng)';
$lang_module['setting_order_to_admin'] = 'Đặt hàng dự án gửi tới Ban quản trị';
$lang_module['setting_order_to_member'] = 'Đặt hàng dự án gửi tới người đăng dự án';
...
$lang_module['setting_active_order_popup'] = 'Hiển thị cửa sổ xem chi tiết dự án khi đặt hàng tại trang chủ';
$lang_module['setting_active_price'] = 'Hiển thị giá dự án';
$lang_module['setting_active_order_number'] = 'Kích hoạt chức năng đặt hàng không giới hạn số lượng dự án';
...
$lang_module['setting_active_tooltip'] = 'Bật chức năng tooltip cho dự án';
$lang_module['setting_show_product_code'] = 'Hiển thị mã dự án';
$lang_module['setting_active_wishlist'] = 'Sử dụng chức năng dự án yêu thích';
...
$lang_module['viewcat_page'] = 'Cách thể hiện loại dự án';
...
$lang_module['view_home_none'] = 'Không hiển thị dự án';
$lang_module['view_home_all'] = 'Hiển thị tất cả dự án lên trang chủ';
$lang_module['view_home_cat'] = 'Hiển thị theo loại dự án';
$lang_module['view_home_group'] = 'Hiển thị theo nhóm dự án';
$lang_module['cat_have_product_err'] = 'Bạn không thể thêm loại dự án vào chủ đề đã có dự án bên trong';
$lang_module['cat_do_not_add'] = 'Không thêm được';
$lang_module['error_cat_name'] = 'Không có tên chủ đề';
$lang_module['error_weight'] = 'Lỗi: Bạn cần nhập khối lượng dự án';
$lang_module['search'] = 'Tìm kiếm';
$lang_module['search_type'] = 'Tìm kiếm theo';
$lang_module['search_id'] = 'ID';
$lang_module['search_key'] = 'Từ khóa tìm kiếm';
$lang_module['search_cat'] = 'Loại dự án';
$lang_module['search_cat_all'] = 'Tất cả các loại dự án';
$lang_module['search_title'] = 'Tên dự án';
$lang_module['search_product_code'] = 'Mã dự án';
$lang_module['search_bodytext'] = 'Nội dung';
$lang_module['search_author'] = 'Tác giả dự án';
...
$lang_module['content_edit'] = 'Sửa dự án';
$lang_module['error_title'] = 'Lỗi: dự án chưa có tên';
$lang_module['error_product_code'] = 'Lỗi: Mã dự án bạn chọn bị trùng';
$lang_module['error_bodytext'] = 'Lỗi: dự án chưa có nội dung';
$lang_module['error_hometext'] = 'Lỗi: Phần giới thiệu ngắn gọn chưa có nội dung';
$lang_module['error_product_unit'] = 'Bạn cần thêm đơn vị cho dự án';
$lang_module['error_cat'] = 'Lỗi: dự án chưa có loại dự án';
$lang_module['error_product_price'] = 'Lỗi: giá dự án không được âm hoặc bằng 0. Nếu bạn không muốn hiển thị giá, hãy hủy tùy chọn Cho phép hiển thị giá dự án này ở phần Tính năng mở rộng';
...
$lang_module['content_cat'] = 'Loại dự án';
$lang_module['content_block'] = 'dự án thuộc các block';
$lang_module['content_homeimg'] = 'Hình minh họa';
$lang_module['content_homeintro'] = 'Hình intro';
$lang_module['content_homeimgalt'] = 'Chú thích cho hình minh họa (phần chi tiết dự án)';
...
$lang_module['content_allowed_send'] = 'Cho phép gửi dự án';
$lang_module['content_allowed_print'] = 'Cho phép in dự án';
$lang_module['content_allowed_save'] = 'Cho phép lưu dự án';
...
$lang_module['content_copyright'] = 'Giữ bản quyền dự án';
$lang_module['content_archive'] = 'Lưu trữ sau thời gian hết hạn';
$lang_module['content_showprice'] = 'Cho phép hiển thị giá dự án này';
$lang_module['content_promotional'] = 'Khuyến mại';
$lang_module['content_warranty'] = 'Bảo hành';
$lang_module['content_showorder'] = 'Cho phép đặt hàng dự án này';
$lang_module['imgposition'] = 'Hình ảnh tại dự án';
...
$lang_module['addtoblock'] = 'Thêm dự án vào block';
$lang_module['delete_from_block'] = 'Xóa dự án khỏi block';
$lang_module['error_del_content'] = 'Lỗi: Hệ thống không xóa hết được các dự án, vui lòng thử lại';
$lang_module['msgnocheck'] = 'Bạn cần chọn ít nhất 1 dự án để thực hiện';
$lang_module['block'] = 'Block dự án';
$lang_module['block_name'] = 'Tên block dự án';
$lang_module['block_error_name'] = 'Lỗi: Tên block dự án không được để trống';
$lang_module['block_error_alias'] = 'Lỗi: Liên kết tĩnh này đã tồn tại, hãy chọn tên khác';
$lang_module['adddefaultblock'] = 'Chọn mặc định khi đăng dự án';
$lang_module['cat_no'] = 'STT';
$lang_module['num_product'] = ' dự án';
$lang_module['content_product_shop'] = 'Gian hàng';
$lang_module['prounit'] = 'Đơn vị dự án';
$lang_module['prounit_name_unit'] = 'Tên đơn vị dự án';
...
$lang_module['format_code_id'] = 'Định dạng mã dự án tự động';
...
$lang_module['table_product'] = 'Bảng dữ liệu dự án';
...
$lang_module['order_products_name'] = 'dự án';
...
$lang_module['product_number_all'] = 'Tổng số dự án đã cập nhật';
$lang_module['product_number_all_noctive'] = 'Tổng số dự án đã cập nhật nhưng chưa duyệt';
$lang_module['product_number_commet'] = 'Tổng số bình luận cho dự án';
$lang_module['product_number_all_store'] = 'Tổng số dự án còn lại trong kho';
...
$lang_module['product_unit'] = 'dự án';
$lang_module['product_comment'] = 'bình luận';
$lang_module['product_order'] = 'đơn đặt';
$lang_module['detail_info'] = 'Chi tiết';

$lang_module['group'] = 'Nhóm dự án';
$lang_module['group_sub_sl'] = 'Nhóm chính';
$lang_module['edit_group'] = 'Sửa nhóm dự án';
$lang_module['add_group'] = 'Thêm nhóm dự án';
$lang_module['group_name'] = 'Tên nhóm dự án';
...
$lang_module['setting_compare'] = 'Bật chức năng so sánh dự án';
...
$lang_module['product_copy_note'] = 'Sao chép dự án';
...
$lang_module['discount_from'] = 'Từ dự án';
$lang_module['discount_to'] = 'Đến dự án';
...
$lang_module['content_tags_empty'] = 'Chú ý: dự án chưa có từ khóa nào';
$lang_module['content_tags_empty_auto'] = 'Hệ thống sẽ tạo tự động từ khóa lúc lưu dự án này, có thể tắt tính năng tự động tạo từ khóa ở phần cấu hình module';

$lang_module['report_detail'] = 'Thống kê chi tiết';
$lang_module['num_selled'] = 'Đã bán';
$lang_module['seller_list'] = 'Danh sách khách hàng mua dự án "%s"';
...
$lang_module['review'] = 'Đánh giá dự án';
...
$lang_module['review_add_time'] = 'Thời gian đăng';
$lang_module['review_setting_active'] = 'Sử dụng chức năng đánh giá dự án';
...
$lang_module['review_notification_review_new'] = '<strong>%s</strong> đánh giá dự án <strong>%s</strong>';
$lang_module['review_notification_review_new_queue'] = '<strong>%s</strong> đánh giá dự án <strong>%s</strong>, bạn cần xem xét đánh giá này trước khi cho phép hiển thị';
...
$lang_module['coupons_product'] = 'dự án áp dụng';
$lang_module['coupons_product_note'] = 'Nếu nhập dự án, giảm giá chỉ áp dụng đối với tổng giá của các dự án này, không áp dụng cho tổng đơn hàng';
$lang_module['coupons_product_custom'] = 'dự án tùy chọn';
$lang_module['coupons_product_custom_edit'] = 'Sửa mã giảm giá để xem danh sách dự án';
...
$lang_module['cat_allow_point'] = 'Cho phép tích lũy điểm với các dự án loại này';
$lang_module['cat_number_point'] = 'Số điểm thưởng khi mua các dự án loại này';
$lang_module['cat_number_product'] = 'Số lượng mỗi dự án ít nhất để đạt được điểm';
